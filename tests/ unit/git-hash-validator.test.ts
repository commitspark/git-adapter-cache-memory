...
describe('GitHashValidator', () => {
  ...
  it('should return false for an empty string', () => {
    const hash = ''
    expect(gitHashValidator.hasHashFormat(hash)).toBe(false)
  })
